...
[HPOlib](http://www.automl.org/benchmarks.html) provides some benchmark functions for Python.

[Finck et al (2009)](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.232.650&rep=rep1&type=pdf) provide details for 24 benchmark functions.
